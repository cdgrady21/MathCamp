...
- Introduction (1:30pm): math camp, why we did it, how it will prepare them. who is teaching it, any questions?
- Point of it all
    - What we use math for: 
    - Identifying an effect of X on Y
    - Conditions: when X –> Y?
...
- Review (9:30am)
    - Review & questions from probability & statistics + reading tables/plots
- **Module One (9:45am-12:00pm)**
    - Types of data
        - Characters, factors, numerics
        - Types of objects
